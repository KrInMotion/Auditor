...
namespace Auditor.Migrations
{
    ...
    partial class V10
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Auditor.Models.AuditorUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Auditor.Models.AppRole", b =>
                {
            ...
            modelBuilder.Entity("Auditor.Models.WifiCheck", b =>
                {
                    b.HasOne("Auditor.Models.AuditorUser", "Responsible")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Auditor.Models.AppUser")
                        .WithMany("Claims")
